package BasicsOfProgramming.N11Cycles;

public class Cycles {
    public static void main(String[] args) {
        // Циклы
        // Еще одним видом управляющих конструкций являются циклы. Циклы позволяют в
        // зависимости от определенных условий выполнять определенное действие множество
        // раз. В языке Java есть следующие виды циклов:
        ...
        // while. И пока это условие истинно, цикл повторяется. Например:
        int j = 7;
        do {
